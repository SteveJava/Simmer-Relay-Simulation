...
public class Swimmer extends Thread {
	...
	private static final int NUM_SWIMMERS = 10;
	private static CyclicBarrier barrier = new CyclicBarrier(NUM_SWIMMERS); // countdown from 10
	private static CountDownLatch latch = new CountDownLatch(NUM_SWIMMERS); //
	private static Lock lock = new ReentrantLock(); // new lock for swim order
